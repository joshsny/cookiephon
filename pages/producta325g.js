          ...
          <div className="flex flex-wrap mx-auto lg:w-4/5">
            ...
            <div className="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
              ...
              <p className="leading-relaxed">
                Cookiephone A32 5G wygląda świetnie i najlepiej czuje się w
                Twoich rękach. Subtelny design wyróżniają delikatne kolory oraz
                niewielka wyspa tylnego aparatu, co zapewnia ikoniczny styl.
                Wybierz jeden z czterech kolorów, aby wyrazić siebie: biały,
                czarny, niebieski lub fioletowy.{" "}
              </p>
