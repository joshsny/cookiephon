          ...
          <div className="flex flex-wrap mx-auto lg:w-4/5">
            ...
            <div className="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
              ...
              <p className="leading-relaxed">
                Cookiephone 11 Pro ma system dwóch aparatów. Baterię na cały
                dzień. Potężną technologie cookiePHONES%5. I ultrawytrzymały
                papierowy tył posklejany z 3-warstowego papieru odpornego na
                zarysowania.{" "}
              </p>
